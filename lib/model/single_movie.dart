...
class SingleMovies {
  ...
  SingleMovies({this.status, this.msg, this.data});

  SingleMovies.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['items'] != null) {
      items = <SingleMovieItems>[];
      json['items'].forEach((v) {
        items!.add(new SingleMovieItems.fromJson(v));
      });
    }
    params =
...
class SingleMovieItems {
  ...
  SingleMovieItems.fromJson(Map<String, dynamic> json) {
