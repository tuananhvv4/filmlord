...
class CartoonMovies {
  ...
  CartoonMovies({this.status, this.msg, this.data});

  CartoonMovies.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    msg = json['msg'];
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['items'] != null) {
      items = <CartoonMovieItems>[];
      json['items'].forEach((v) {
        items!.add(new CartoonMovieItems.fromJson(v));
      });
    }
    params =
...
class CartoonMovieItems {
  ...
  CartoonMovieItems.fromJson(Map<String, dynamic> json) {
