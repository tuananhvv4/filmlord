...
import '../../controller/fireBase/activity_firebase_controller.dart';
          ...
          if(snapshot.hasData && snapshot.data!.docs.isNotEmpty){
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final Timestamp activityTime = activityData['time'] ?? Timestamp.now();
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: ListTile(
                      title: Text(activityData['content'],
                        style: const TextStyle(color: Colors.white,fontSize: 13,fontWeight: FontWeight.w600),),
                      subtitle: Text('Phim: ${activityData['movie']}',
                        style: const TextStyle(color: Colors.white,fontSize: 13,fontWeight: FontWeight.w300),),
                      trailing: Text(formatElapsedTime(activityTime)), // Hiển thị thời gian comment theo yêu cầu
                    ),
                  ),
                );
              },
