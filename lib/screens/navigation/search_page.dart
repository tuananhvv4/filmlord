  ...
  Future<void> loadMore() async {
    if (controller.position.maxScrollExtent == controller.offset) {
      ...
      setState(() {
        ...
        endPosition += 10;
        urlSearchMovies =
            'https://nguyenanh.site/api/movie_app/search-movie.php?keyword=$searchKeyword&start=$startPosition&end=$endPosition';
      });
      var searchMoviesResponse = await http.get(Uri.parse(urlSearchMovies));
      var searchMoviesJsonData = jsonDecode(searchMoviesResponse.body);
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: CachedNetworkImage(
                                                  imageUrl:
                                                      'https://www.kkphim.vip/${searchMovieItemsList[index].thumbUrl}',
                                              ...
                                              Expanded(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Tên: ${searchMovieItemsList[index].name.toString()}',
                                                    ...
                                                    // ),
                                                    Text(
                                                      'Thời lượng: ${searchMovieItemsList[index].time.toString()}',
                                                      style: const TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 12,
                                                          overflow: TextOverflow
                                                    ...
                                                    Text(
                                                      'Năm: ${searchMovieItemsList[index].year.toString()}',
                                                      style: const TextStyle(
                                                          color: Colors.white,
                                                          fontSize: 12,
                                                          overflow: TextOverflow
                          ...
                          builder: (context, snapshot) {
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Column(
                                children: [
                                  const Text(
                                    'Chương trình truyền hình và phim được đề xuất!',
                                    style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 19,
