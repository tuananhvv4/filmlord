...
class FlickSeekVideoActionCustom extends StatelessWidget {
  const FlickSeekVideoActionCustom({
    Key? key,
    this.child,
    this.forwardSeekIcon = const Icon(Icons.forward_10,size: 50,),
    this.backwardSeekIcon = const Icon(Icons.replay_10,size: 50,),
