...
class LandscapePlayerControls extends StatefulWidget {
  ...
  @override
  State<LandscapePlayerControls> createState() => _LandscapePlayerControlsState();
}
...
class _LandscapePlayerControlsState extends State<LandscapePlayerControls> {
  ...
  void initState() {
    super.initState();
    currentEpisodeIndex = widget.initialEpisodeIndex; // Initialize with the passed index
  }
  ...
  openEpisodeDialog(){
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _scrollController.jumpTo(
        (widget.initialEpisodeIndex / 4) * 70, // Chia theo số cột của GridView (4 cột ở đây)
      );
    });
      ...
      builder: (context) {
        ...
        return AlertDialog(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: const BorderSide(color: Colors.white24, width: 2), // Màu và độ dày của viền
          ),
          title: const Text('Danh sách tập',
          style: TextStyle(
            color: Colors.white,
          ),),
          content: SizedBox(
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: widget.initialEpisodeIndex == index ? Colors.white54 : Colors.white12,
                  ...
                  child: MaterialButton(onPressed: () {
                    ...
                    child:  Text(widget.movieEpisodeName[index],
                    maxLines: 1,
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                PopupMenuButton(
                                  ...
                                  itemBuilder: (context) => playbackSpeeds.map((speed) => PopupMenuItem(
                                    height: 30,
                                    value: speed,
                                    child: Text('x$speed',),)).toList(),
                                  onSelected: (newSpeed){
                                    setState(() {
                                      playBackSpeed = newSpeed;
                                    });
                                    controlManager.setPlaybackSpeed(playBackSpeed);
                                    controlManager.togglePlay();
                                  },
                                ...
                                widget.initialEpisodeIndex > 0
                                    ...
                                    : const SizedBox(),
                                widget.initialEpisodeIndex < widget.episodesLength - 1
                                ? TextButton(
                                    ...
                                    : const SizedBox(),
                                Visibility(
                                visible: widget.movieDetail.type != 'single',
                                    child: MaterialButton(onPressed: () {
                                  openEpisodeDialog();
                                },
                                  child: const Row(
                                    children: [
                                      ...
                                      SizedBox(width: 5,),
                                      Text('Danh sách tập',style: TextStyle(color: Colors.white),)
                                    ],
                                  ),))
                              ],
                            ),
                                ...
                                onPressed: () {
                                  ...
                                  if(stateController.loginState.value){
                                    historyController.updateWatchingTime(widget.movieDetail.slug.toString(),
                                        widget.movieEpisodeName[currentEpisodeIndex], videoManager.videoPlayerValue!.position.inMinutes.toInt());
                                  }
                                  movieController.initSeekTime();
