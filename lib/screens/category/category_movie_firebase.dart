...
class CategoryMovieFirebase extends StatefulWidget {
  ...
  const CategoryMovieFirebase({super.key, required this.title, required this.category});
...
class _CategoryMovieFirebaseState extends State<CategoryMovieFirebase> {
  ...
  void removeItem(String docID) async {
    bool isRemoved = await firebaseController.deleteDocumentWithSubCollections(docID, widget.category);
    if(isRemoved){
              ...
              return  Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Bạn chưa thêm bộ phim nào vào danh sách của mình!',
                      style: TextStyle(
                          fontSize: 15,
                            ...
                            children: [
                              Container(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: processUrl(documentSnapshot['thumb_url']),
